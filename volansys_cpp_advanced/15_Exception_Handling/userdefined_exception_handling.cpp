/**
 * @file userdefined_exception_handling.cpp
 * @author rohirto
 * @brief Demo of User defined Exception handling by deriving a user class based on runtime_error base class
 * @version 0.1
 * @date 2023-12-20
 * 
...
public: 
	...
	Exception() 
		: runtime_error("User Defined Math error: Attempted to divide by Zero\n") 
	{ 
	} 
}; 
